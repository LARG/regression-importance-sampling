...
if plottype == 'gw-alternatives':
    ...
    if offpolicy:
        methods_to_plot = ['ris', 'wris', 'ris_wdr', 'is', 'wis', 'is_wdr']
    else:
        methods_to_plot = ['ris', 'ris_dr', 'is', 'is_dr']
elif plottype == 'gw-all-baselines':
    if offpolicy:
        methods_to_plot = ['ris', 'wris', 'pdris', 'ris_dr', 'ris_wdr', 'is',
                           'wis', 'pdis', 'is_dr', 'is_wdr']
    else:
        methods_to_plot = ['ris', 'ris_dr', 'pdris', 'wris', 'is', 'is_dr', 'ris_wdr']
